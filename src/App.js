...
function App() {
  ...
  async function handleSubmit(e){
    ...
    const response=await fetch("https://dheerajcl.github.io/Chat-GPT/api",{
      method:"POST",
      headers:{
  ...
  return (
    ...
    <div className="sidemenu-title">ChatGPT</div>
      <div className="sidemenu-button" onClick={clearChat}>
        <span>+</span> 
        New Chat
      </div>
      <div className="ToggleIcon" onClick={toggleLightMode}>
